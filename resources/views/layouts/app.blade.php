...
<body class="hold-transition login-page" style="background-image: url('{{ asset("img/wallup.jpg") }}'); background-size: cover; background-attachment: fixed;">
  <div class="login-box">
    <div class="login-logo">
      <img src="{{ asset('img/logosmk.png') }}" width="100%" alt="">
    </div>
    ...
    <footer style="color: white;">
      <marquee>
          <strong>Copyright &copy; <script>document.write(new Date().getFullYear());</script> &diams; <a href="http://smkkomputamajeruklegi.sch.id/" style="color: white;">AGUNG SAHRUL BAHRI</a>. </strong>
      </marquee>
    </footer>
  </div>
...
@error('id_card')
  <script>
    toastr.error("Maaf User ini tidak terdaftar sebagai Guru SMK Komputama Jeruklegi!");
  </script>
@enderror
@error('guru')
  <script>
...
@error('no_induk')
  <script>
    toastr.error("Maaf User ini tidak terdaftar sebagai Siswa SMK Komputama Jeruklegi!");
  </script>
@enderror
@error('siswa')
  <script>
